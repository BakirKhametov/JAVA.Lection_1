...
// для того чтобы начать работать надо набрать "Class"
// и выбрать нижнее значение в выводящем списке
...
public class program {
    ...
    } // System.out.println("bye world"); можно вывести с  помощью снипета "sysout"
                                                                                                                            //       _
    //  для того чтобы вывести верхнее значение необходимо набрать  "main" и выбрать верхнее значение  в выводящем списке (main     |_|)
